...
const prodConfig: Configuration = {
    ...
    minimizer: [
      new TerserPlugin<SwcOptions>({
        ...
        terserOptions: {
          ...
          compress: { unused: true, pure_funcs: ['console.info', 'console.debug', 'console.warn'] }, // remove this functions when their return values are not used
        },
      }),
    ],
    splitChunks: {
  ...
  plugins: [
    PluginBuilder.createProcessEnvVariablesPlugin({ env: 'production' }),
